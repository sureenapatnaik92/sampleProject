package com.doble.enhancedReport;
 ...
 */
public class CustomTestNGEmailableReport implements IReporter {
	
    private static final Logger LOG = Logger.getLogger(CustomTestNGEmailableReport.class);
    ...
    protected void writeDocumentStart() {
        writer.println("<!DOCTYPE html PUBLIC \"-//W3C//DTD XHTML 1.1//EN\" \"https://www.w3.org/TR/xhtml11/DTD/xhtml11.dtd\">");
    ...
    protected void writeSuiteSummary() {
        ...
        // Print total if there is more than one test
        if (testIndex > 1) {
        ...
        if (!classResults.isEmpty()) {
            ...
            for (ClassResult classResult : classResults) {
                ...
                for (MethodResult methodResult : classResult.getMethodResults()) {
                    ...
                    // The first method per class shares a row with the class header
    				if (methodIndex > 0) {
                    ...
                    // Write remaining scenarios for the method
                ...
                // Write test results for the class
